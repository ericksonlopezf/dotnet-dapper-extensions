...
public sealed class PagedQueryExtensionsTests
{
    ...
    public async Task QueryCursorPagedAsync_WithExistingWhereClause_AppendsAndConnector()
    {
        var sampleCustomers = new List<Customer>
        {
            new(11, "Customer 011", "c11@example.com"),
            new(12, "Customer 012", "c12@example.com"),
            new(13, "Customer 013", "c13@example.com"),
            new(14, "Customer 014", "c14@example.com"),
            new(15, "Customer 015", "c15@example.com"),
            new(16, "Customer 016", "c16@example.com")
        };
        string? capturedSql = null;
        using var connection = new TestAdoConnection
        {
            ReaderFactory = (sql, _) => { capturedSql = sql; return CreateDefaultCustomerReader(sampleCustomers); }
        };
        var parameters = new CursorPaginationParameters { First = 5, After = "10" };
    ...
    public async Task QueryCursorPagedAsync_BackwardWithExistingWhereClause_AppendsAndConnector()
    {
        var sampleCustomers = new List<Customer>
        {
            new(19, "Customer 019", "c19@example.com"),
            new(18, "Customer 018", "c18@example.com"),
            new(17, "Customer 017", "c17@example.com"),
            new(16, "Customer 016", "c16@example.com"),
            new(15, "Customer 015", "c15@example.com"),
            new(14, "Customer 014", "c14@example.com")
        };
