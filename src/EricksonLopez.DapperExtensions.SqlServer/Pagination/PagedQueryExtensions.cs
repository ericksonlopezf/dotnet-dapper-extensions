...
namespace EricksonLopez.DapperExtensions.SqlServer.Pagination;

/// <summary>
/// Provides extension methods for executing paginated queries with Dapper on SQL Server databases.
/// </summary>
public static class PagedQueryExtensions
{
        ...
        int? commandTimeout = null)
    {
        ...
        var pagedSql = $"{sql} OFFSET {offset} ROWS FETCH NEXT {pagination.PageSize} ROWS ONLY";
        ...
        int? commandTimeout = null)
    {
        ...
        using var multi = await connection.QueryMultipleAsync(
            sql, param, transaction, commandTimeout).ConfigureAwait(false);
        ...
        int? commandTimeout = null)
    {
        ...
        if (!System.Text.RegularExpressions.Regex.IsMatch(cursorColumn, @"^[a-zA-Z0-9_\[\]\""\.]+$"))
        ...
        string finalSql = $"{filterSql} ORDER BY {cursorColumn} {sortDirection} OFFSET 0 ROWS FETCH NEXT {fetchLimit} ROWS ONLY";
