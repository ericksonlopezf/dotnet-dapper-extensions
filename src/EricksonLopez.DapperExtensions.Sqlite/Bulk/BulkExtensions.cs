...
/// <summary>
/// Provides extension methods for bulk INSERT, UPSERT, UPDATE, and DELETE operations on SQLite connections.
/// </summary>
public static class BulkExtensions
{
    ...
    /// <summary>
    /// Executes a bulk INSERT ... ON CONFLICT DO UPDATE (upsert) statement using pre-built SQL and parameters.
    /// </summary>
    /// <param name="connection">The database connection to execute the command on.</param>
