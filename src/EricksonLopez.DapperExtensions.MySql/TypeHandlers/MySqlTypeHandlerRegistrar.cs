...
namespace EricksonLopez.DapperExtensions.MySql.TypeHandlers;

/// <summary>
/// Provides convenience registration methods for MySQL JSON type handlers.
/// </summary>
public static class MySqlTypeHandlerRegistrar
{
    /// <summary>
