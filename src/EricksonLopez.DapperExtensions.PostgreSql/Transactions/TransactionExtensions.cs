...
namespace EricksonLopez.DapperExtensions.PostgreSql.Transactions;

/// <summary>
/// Provides extension methods for executing operations within a PostgreSQL transaction scope.
/// </summary>
