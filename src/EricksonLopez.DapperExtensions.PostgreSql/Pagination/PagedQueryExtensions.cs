...
namespace EricksonLopez.DapperExtensions.PostgreSql.Pagination;

/// <summary>
/// Provides extension methods for executing paginated queries with Dapper on PostgreSQL databases.
/// </summary>
