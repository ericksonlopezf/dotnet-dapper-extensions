...
| [ADR-007](adr-007-multi-map-root-deduplication-and-1-to-n-grouping.md) | Multi-Map Root Deduplication and 1-to-N Grouping | Accepted |
| [ADR-008](adr-008-standard-type-handlers-and-di-boundary.md) | Standard Type Handlers and Dependency Injection Boundary | Accepted |
| [ADR-009](adr-009-multi-provider-bulk-strategy.md) | Multi-Provider Bulk Operation Strategy | Accepted |
| [ADR-010](adr-010-opentelemetry-observability-package.md) | OpenTelemetry Observability Package and Semantic Conventions | Accepted |
| [ADR-011](adr-011-healthchecks-package-and-probe-architecture.md) | HealthChecks Package and Dialect Probe Architecture | Accepted |
