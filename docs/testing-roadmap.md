...
This document serves as the **single source of truth, execution guide, reproducible evidence, and idempotent tracking mechanism** for the testing, cleanup, and mutation testing strategy of `EricksonLopez.DapperExtensions`.
...
```
src/
├── EricksonLopez.DapperExtensions               # Package component
├── EricksonLopez.DapperExtensions.DependencyInjection# Package component
├── EricksonLopez.DapperExtensions.HealthChecks  # Package component
├── EricksonLopez.DapperExtensions.MariaDb       # Package component
├── EricksonLopez.DapperExtensions.MySql         # Package component
├── EricksonLopez.DapperExtensions.OpenTelemetry # Package component
├── EricksonLopez.DapperExtensions.Oracle        # Package component
├── EricksonLopez.DapperExtensions.PostgreSql    # Package component
├── EricksonLopez.DapperExtensions.SourceGenerators# Package component
├── EricksonLopez.DapperExtensions.Sqlite        # Package component
├── EricksonLopez.DapperExtensions.SqlServer     # Package component
```
...
| **U02** | `DependencyInjection` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U03** | `HealthChecks` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U04** | `MariaDb` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U05** | `MySql` | `ADAPTER` | `DONE` | 100% | 100% | 100% | 100% |
| **U06** | `OpenTelemetry` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U07** | `Oracle` | `COMPONENT` | `DONE` | 100% | 100% | 100% | 100% |
| **U08** | `PostgreSql` | `ADAPTER` | `DONE` | 100% | 100% | 100% | 100% |
| **U09** | `SourceGenerators` | `GENERATOR` | `DONE` | 100% | 100% | 100% | 100% |
| **U10** | `Sqlite` | `ADAPTER` | `DONE` | 100% | 100% | 100% | 100% |
| **U11** | `SqlServer` | `ADAPTER` | `DONE` | 100% | 100% | 100% | 100% |
