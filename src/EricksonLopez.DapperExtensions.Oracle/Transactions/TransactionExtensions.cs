...
namespace EricksonLopez.DapperExtensions.Oracle.Transactions;

/// <summary>
/// Provides extension methods for executing operations within an Oracle Database transaction scope.
/// </summary>
