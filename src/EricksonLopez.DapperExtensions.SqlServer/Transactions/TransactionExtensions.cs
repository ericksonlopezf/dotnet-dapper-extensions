...
namespace EricksonLopez.DapperExtensions.SqlServer.Transactions;

/// <summary>
/// Provides extension methods for executing operations within a SQL Server transaction scope.
/// </summary>
