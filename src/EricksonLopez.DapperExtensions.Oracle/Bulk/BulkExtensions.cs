...
/// <summary>
/// Provides extension methods for bulk INSERT, UPSERT, UPDATE, and DELETE operations on Oracle Database connections.
/// </summary>
public static class BulkExtensions
{
    ...
    /// <summary>
    /// Executes a bulk MERGE (upsert) statement using pre-built SQL and parameters.
    /// </summary>
    /// <param name="connection">The database connection to execute the command on.</param>
    /// <param name="sql">The multi-row MERGE SQL statement.</param>
