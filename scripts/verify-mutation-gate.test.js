...
(async () => {
  let failed = false;
  const mockContext = {
    repo: { owner: 'ericksonlopezf', repo: 'dotnet-dapper-extensions' },
    sha: 'abc1234567890'
  };
                ...
                statuses: [
                  {
                    ...
                    target_url: 'https://github.com/ericksonlopezf/dotnet-dapper-extensions/actions/runs/12345'
                  }
                ]
              }
            };
              ...
              statuses: [
                {
                  ...
                  updated_at: freshDate,
                  target_url: 'https://github.com/ericksonlopezf/dotnet-dapper-extensions/actions/runs/12346'
                }
              ]
            }
          };
